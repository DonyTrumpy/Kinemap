  ...
  <body>
    ...
    <div class="container">
		...
		<form class="form-signin" method="post" action="registerUser.php">
			...
			<label for="stateno" class="sr-only">Full Name</label><br>
			<input type="text" id="stateno" name ="fullname" class="form-control mb-2" placeholder="Full Name" required autofocus>
