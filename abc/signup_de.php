  ...
  <body>
    ...
    <div class="container">
		...
		<form class="form-signin" method="post" action="registerUser.php">
			...
			<label for="stateno" class="sr-only">Vollständiger Name</label><br>
			<input type="text" id="stateno" name ="fullname" class="form-control mb-2" placeholder="Vollständiger Name" required autofocus>
			...
			<label for="username" class="sr-only">Nutzername</label><br>
			<input type="text" id="username" name ="username" class="form-control mb-2" placeholder="Nutzername" required autofocus>
			<label for="password" class="sr-only">Passwort</label><br>
			<input type="password" id="password" name ="password" class="form-control" placeholder="Passwort" required> <br><br><br>
			<button class="btn btn-md btn-primary btn-block" type="submit" id="SignUp" name="submit">Registrieren</button>
		</form>
