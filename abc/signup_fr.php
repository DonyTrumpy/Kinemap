...
#SignUp{background:#059041;} #SignUp:hover{background:#49E038;transition: 0.8s;}
  ...
  <body>
		...
		<nav id="header">   <img src = "../images/KinemapFullLogooo.png" id="Logo" alt = "Logo" onclick="window.location='../home/home_fr.php'" > <ul id="ul">
    ...
    <div class="container">
		...
		<form class="form-signin" method="post" action="registerUser.php">
			...
			<label for="stateno" class="sr-only">Nom Complet</label><br>
			<input type="text" id="stateno" name ="fullname" class="form-control mb-2" placeholder="Nom Complet" required autofocus>
			<label for="fullname" class="sr-only">Email</label><br>
			<input type="email" id="fullname" name ="emailid" class="form-control mb-2" placeholder="Email" required autofocus>
			<label for="username" class="sr-only">Nom d'utilisateur</label><br>
			<input type="text" id="username" name ="username" class="form-control mb-2" placeholder="Nom d'utilisateur" required autofocus>
			<label for="password" class="sr-only">Mot de passe</label><br>
			<input type="password" id="password" name ="password" class="form-control" placeholder="Mot de passe" required> <br><br><br>
			<button class="btn btn-md btn-primary btn-block" type="submit" id="SignUp" name="submit">S'inscrire</button>
		</form>
