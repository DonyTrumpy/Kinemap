...
#Mes2{font-size: 8px;left:76vw;}}
    ...
    <body>
      <nav >
           <img src = "../images/KinemapFullLogooo.png" id="Logo" alt = "Logo" onclick="window.location='../'"style ="width: 135px; height : 50px;" >
...
<h1 id="h11">Green Deal</h1> <div class="P"> <p>1 year</p> <p class="Price">14.99€ / year</p>

    <p>48h Response</p> <p>Access to all products</p>
  </div>
</a>

  <a class= "container2" href="../abc/checkout.php?plan=2&price=24.99">
  <h1 id="h12">Orange Deal</h1>
  <div class="P"> <p>2 years</p> <p class="Price">24.99€  &nbsp;&nbsp;  ( 12.49€ / year)</p>
...
<h1>A small gesture to save our planet,</h1>
</div>
<div id="Mes2" class="Mes">
  <h1>60% of the profit is</h1>
  <h1>redistributed to humanitarian projects.</h1>
</div>
