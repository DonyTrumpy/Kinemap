...
<html>
   <head>
      ...
      <script src="../js/code.js"></script>
				<?php
					if ($count != "")
						echo '<title>Kinemap | Dag, '.$name.'</title>';
					else
						echo '<title>Kinemap | Dag, '.$_SESSION['u_name'].'</title>';
				?>
...
@media screen and (max-width: 933px){
   ...
   <body onload="init()">
		 ...
		 <nav >
					<img src = "../images/KinemapFullLogooo.png" id="Logo" alt = "Logo" onclick="window.location='../home/home_ne.php'"
					style ="width: 140px; height : 60px;" >

					<ul>
		<li><a class="hovv" href="../home/home_ne.php">HOME</a></li>
		<li><a class="hovv" href="../map/map_ne.php">KAART</a></li>
		<li><a class="hovv" href="../login/login_ne.php">LOG IN | SIGN UP</a></li>
		...
		<div id="WTFF">
			...
			<a href="../login/login_ne.php">LOG IN | SIGN UP</a>
		</div>
		 ...
		 <div class="popup" id="popup-1">
			 ...
			 <div class="content">
				 ...
				 <h1>Selecteer een taal</h1><br><br>
      ...
      <div class="container">
         ...
         <div class="left">
            <div class="box">
               <h2 id="White"> Vul uw gegevens in </h2>
				 ...
				 <form method="post" action="" enctype="multipart/form-data" id="myform">
					 ...
					 <div class='preview'>
						 ...
						 ?>
											 ...
											 <label id="lblPic">Kies een profielfoto</label>
				 </form>
											 <script type="text/javascript">
                     ...
                     <div class="marginDiv">
				 							<?php
				 								if ($count != "")
				 									echo '<input type="text" name="UserName" id="TName" class="TName" placeholder="&nbsp;Uw volledige naam" maxlength="25" required value='.$name.'>';
				 								else
				 									echo '<input type="text" name="UserName" id="TName" class="TName" placeholder="&nbsp;Uw volledige naam" maxlength="25" required>';
				 							?>
												<input type="password" name="password" id="password" class="TName" placeholder="&nbsp;Wachtwoord" maxlength="25" required>
                     </div>
                  </div>
                  ...
                  <div id="Cont" class="column">
                     <div class="TSpecialisation">
                        ...
                        <div class="marginDiv">
                           <span id="liAddress">&nbsp;Adres:<br></span>
							 							<?php
							 								if ($count != "")
							 									echo '<input type="text" name="Street" id="TStreet" class="TInfo" placeholder="Straat en nummer" maxlength="50" required value='.$addressParts[0].'>
				                        <div class="marginDiv">
																	<input type="text" name="Zipcode" id="TZip" class="TInfo" placeholder="Postcode" maxlength="20" required value='.$addressParts[2].'>
				                        </div>
				                        <div class="marginDiv">
				                           <input type="text" name="City" id="TCity" class="TInfo" placeholder="Stad" maxlength="20" required value='.$addressParts[1].'>
				                        </div>';
							 								else
							 									echo '<input type="text" name="Street" id="TStreet" class="TInfo" placeholder="Straat en nummer" maxlength="50" required>

				                        <div class="marginDiv">
																	<input type="text" name="Zipcode" id="TZip" class="TInfo" placeholder="Postcode" maxlength="20" required>
				                        </div>
				                        <div class="marginDiv">
				                           <input type="text" name="City" id="TCity" class="TInfo" placeholder="Stad" maxlength="20" required>
				                        </div>';
							 							?>
                        </div>
                        <div class="marginDiv">
                           <span id="liWebsite">&nbsp;Link naar online agenda:<br>
							 							<?php
							 								if ($count != "")
...
<br><br><br>
		 					 <?php
		  						 if ($count != "")
               			echo '<textarea type="text" id="DescriptionScript" placeholder="Ik behandel de hele week enkel op afspraak van 8.00 tot 20.00 uur en werk alleen tijdens het weekend op zaterdagochtend tot 13.00 uur. Mijn doel is om u in de best mogelijke vorm te krijgen." maxlength="8500" style="resize: none;" required>'.$description.'</textarea>';
										 else
											echo '<textarea type="text" id="DescriptionScript" placeholder="Ik behandel de hele week enkel op afspraak van 8.00 tot 20.00 uur en werk alleen tijdens het weekend op zaterdagochtend tot 13.00 uur. Mijn doel is om u in de best mogelijke vorm te krijgen." maxlength="8000" style="resize: none;" required></textarea>';
		  					 ?>
               <input type="submit" id="submit" name="" value="Submit">
            </div>
         </div>
         <div id="map" class="right">
            <p id="MapHead">Localiseer uw werkplek</p>
         </div>
      </div>
