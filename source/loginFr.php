...
#role{border-radius: 12px;background:#2E2E2E;}
	    ...
	    <nav id="header">   <img src = "http://localhost/Alexis/images/KinemapFullLogo.png" id="Logo" alt = "Logo" onclick="window.location='http://localhost/Alexis/css/OtherHomeEnglish.html'" > <ul id="ul">
	      <li id="li"><a id="a" href="http://localhost/Alexis/OtherHomeFr.html" class="active"> Home </a></li>
	          <li id="li"><a id="a" href="http://localhost/Alexis/index.php">Carte</a></li>
		     ...
		     <div id="WTFF">
		       <a href="http://localhost/Alexis/OtherHomeFr.html">HOME</a>
		       <a href="http://localhost/Alexis/index.php">Carte</a>
		       <a href="http://localhost/Alexis/loginFr.php">LOG IN | SIGN UP</a>
		     </div>
    ...
    <div class="container">
		...
		<br>	<label for="password" class="sr-only">Mot de passe</label>
			<input type="password" id="passord" name ="pass" class="form-control" placeholder="Password" required> <br><br>
			...
			<br><br><br><br>
			<button class="btn btn-md btn-primary btn-block" type="submit" name="submit" id="Login">S'identifier</button>
			<br><br>
			  <a href="#" id="ForgotPassword"> Mot de passe oublié? </a>
			<a href="http://localhost/Alexis/css/IWantT.html" id="SignUp">S'inscrire</a>
		</form>
