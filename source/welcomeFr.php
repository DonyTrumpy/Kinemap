...
<html>
   <head>
      ...
      <script src="../js/code.js"></script>
				<?php
					if ($count != "")
						echo '<title>Kinemap | Bonjour, '.$name.'</title>';
					else
						echo '<title>Kinemap | Bonjour, '.$_SESSION['u_name'].'</title>';
				?>
...
@media screen and (max-width: 933px){
   ...
   <body onload="init()">
		...
		<div id="WTFF">
		 ...
		 <div class="popup" id="popup-1">
			 ...
			 <div class="content">
				 ...
				 <h1>Sélectionnez une langue</h1><br><br>
      ...
      <div class="container">
         ...
         <div class="left">
            <div class="box">
               <h2 id="White"> Complétez vos informations </h2>
				 ...
				 <form method="post" action="" enctype="multipart/form-data" id="myform">
					 ...
					 <div class='preview'>
						 ...
						 ?>
											 ...
											 <label id="lblPic">Choisissez une photo de profil</label>
				 </form>
											 <script type="text/javascript">
                     ...
                     <div class="marginDiv">
				 							<?php
				 								if ($count != "")
				 									echo '<input type="text" name="UserName" id="TName" class="TName" placeholder="&nbsp;Votre nom complet" maxlength="25" required value='.$name.'>';
				 								else
				 									echo '<input type="text" name="UserName" id="TName" class="TName" placeholder="&nbsp;Votre nom complet" maxlength="25" required>';
				 							?>
												<input type="password" name="password" id="password" class="TName" placeholder="&nbsp;Mot de passe" maxlength="25" required>
                     </div>
                  </div>
						...
						<select multiple="multiple" id="my-select" name="my-select[]">
						 <?php
							 if ($count != "")
							 	echo '
									<option value="Aquatherapy" '.((in_array("Aquatherapy",$specilisationsParts))?'selected="selected"':"").'>Hydrothérapie</option>
                  <option value="Crochetage" '.((in_array("Crochetage",$specilisationsParts))?'selected="selected"':"").'>Crochetage</option>
									<option value="Cryotherapy" '.((in_array("Cryotherapy",$specilisationsParts))?'selected="selected"':"").'>Cryothérapie</option>
									<option value="Lymphatic drainage" '.((in_array("Lymphatic drainage",$specilisationsParts))?'selected="selected"':"").'>Drainage lymphatique</option>
									...
									<option value="Electrotherapy" '.((in_array("Electrotherapy",$specilisationsParts))?'selected="selected"':"").'>Electrothérapie</option>
									<option value="Fasciatherapy" '.((in_array("Fasciatherapy",$specilisationsParts))?'selected="selected"':"").'>Fasciathérapie</option>
									<option value="Geriatry" '.((in_array("Geriatry",$specilisationsParts))?'selected="selected"':"").'>Geriatrie</option>
									<option value="Gerontology" '.((in_array("Gerontology",$specilisationsParts))?'selected="selected"':"").'>Gérontologie</option>
									<option value="Sports medicine" '.((in_array("Sports medicine",$specilisationsParts))?'selected="selected"':"").'>Kiné du sport</option>
									<option value="General physical therapy" '.((in_array("General physical therapy",$specilisationsParts))?'selected="selected"':"").'>Kinésithérapie générale</option>
                  <option value="Neurophysician" '.((in_array("Neurophysician",$specilisationsParts))?'selected="selected"':"").'>Neurophysicien</option>
									<option value="Oncology" '.((in_array("Oncology",$specilisationsParts))?'selected="selected"':"").'>Oncology</option>
									...
									<option value="Osteopathy" '.((in_array("Osteopathy",$specilisationsParts))?'selected="selected"':"").'>Ostéopathie</option>
									<option value="Pediatry" '.((in_array("Pediatry",$specilisationsParts))?'selected="selected"':"").'>Pédiatrie</option>
									<option value="Pelvical reeducation" '.((in_array("Pelvical reeducation",$specilisationsParts))?'selected="selected"':"").'>Réeducation pelvienne</option>
									<option value="Cardiovascular therapy" '.((in_array("Cardiovascular therapy",$specilisationsParts))?'selected="selected"':"").'>Thérapie cardiovasculaire</option>
									<option value="Manual therapy" '.((in_array("Manual therapy",$specilisationsParts))?'selected="selected"':"").'>Thérapie manuelle</option>
									<option value="Perinatal therapy" '.((in_array("Perinatal therapy",$specilisationsParts))?'selected="selected"':"").'>Thérapie perinatale</option>
									<option value="Respiratory therapy" '.((in_array("Respiratory therapy",$specilisationsParts))?'selected="selected"':"").'>Thérapie respiratoire</option>
									<option value="Vestibular therapy" '.((in_array("Vestibular therapy",$specilisationsParts))?'selected="selected"':"").'>Thérapie vestibulaire</option>
									<option value="Inwendige aandoeningen" '.((in_array("Inwendige aandoeningen",$specilisationsParts))?'selected="selected"':"").'>Thérapie viscérale</option>
                  <option value="Ultrasound | Shockwave" '.((in_array("Ultrasound / Shockwave",$specilisationsParts))?'selected="selected"':"").'>Ultrasound | Shockwave</option>
									<option value="Uro-Gynecology" '.((in_array("Uro-Gynecology",$specilisationsParts))?'selected="selected"':"").'>Uro-Gynécologie</option>
							 ...
							 echo '
									...
									<option value="Lymphatic drainage">Drainage lymphatique</option>
									<option value="Dry needling/ Acupuncture">Dry needling | Acupuncture</option>
									<option value="Electrotherapy">Electrothérapie</option>
									<option value="Fasciatherapy">Fasciathérapie</option>
									<option value="Geriatry">Geriatrie</option>
									<option value="Gerontology">Gerontologie</option>
									<option value="Aquatherapy">Hydrothérapie</option>
									<option value="Sports medicine">Kiné du sport</option>
									<option value="General physical therapy">Kinésithérapie générale</option>
									<option value="Neurophysician">Neurophysicien</option>
									...
									<option value="Pelvical reeducation">Réeducation pelvienne</option>
									<option value="Cardiovascular therapy">Thérapie cardiovasculaire</option>
									<option value="Manual therapy">Thérapie manuelle</option>
									<option value="Perinatal therapy">Thérapie périnatale</option>
									<option value="Respiratory therapy">Thérapie respiratoire</option>
									<option value="Vestibular therapy">Thérapie vestibulaire</option>
									<option value="Inwendige aandoeningen">Thérapie viscérale</option>
									<option value="Ultrasound / Shockwave">Ultrasound | Shockwave</option>
									<option value="Uro-Gynecology">Uro-Gynécologie</option>
									';
						?>
						</select>
					</div>
                     ...
                     <div class="TSpecialisation">
                        ...
                        <div class="marginDiv">
                           <span id="liPhone">Tel: <br>
							 							<?php
							 								if ($count != "")
							 									echo '<input type="number" name="PhoneNumber" id="TPhone" class="TInfo" placeholder="Numéro de téléphone" maxlength="12" required value='.$telephone.'>';
							 								else
							 									echo '<input type="number" name="PhoneNumber" id="TPhone" class="TInfo" placeholder="Numéro de téléphone" maxlength="12" required>';
							 							?>
                           </span>
                        </div>
                        <div class="marginDiv">
                        ...
                        <div class="marginDiv">
                           <span id="liAddress">&nbsp;Adresse:<br></span>
							 							<?php
							 								if ($count != "")
							 									echo '<input type="text" name="Street" id="TStreet" class="TInfo" placeholder="Rue et numéro" maxlength="50" required value='.$addressParts[0].'>
				                        <div class="marginDiv">
																	<input type="text" name="Zipcode" id="TZip" class="TInfo" placeholder="Code postal" maxlength="20" required value='.$addressParts[2].'>
				                        </div>
				                        <div class="marginDiv">
				                           <input type="text" name="City" id="TCity" class="TInfo" placeholder="Ville" maxlength="20" required value='.$addressParts[1].'>
				                        </div>';
							 								else
							 									echo '<input type="text" name="Street" id="TStreet" class="TInfo" placeholder="Rue et numéro" maxlength="50" required>

				                        <div class="marginDiv">
																	<input type="text" name="Zipcode" id="TZip" class="TInfo" placeholder="Code postal" maxlength="20" required>
				                        </div>
				                        <div class="marginDiv">
				                           <input type="text" name="City" id="TCity" class="TInfo" placeholder="Ville" maxlength="20" required>
				                        </div>';
							 							?>
                        </div>
                        <div class="marginDiv">
                           <span id="liWebsite">&nbsp;Lien vers agenda en ligne:<br>
							 							<?php
							 								if ($count != "")
...
<br><br><br>
		 					 <?php
		  						 if ($count != "")
               			echo '<textarea type="text" id="DescriptionScript" placeholder="Je traite uniquement sur rendez-vous de 8h à 20h toute la semaine et ne travaille que le week-end le samedi matin jusqu à 13h. Mon but est de vous mettre dans la meilleure forme possible." maxlength="8500" style="resize: none;" required>'.$description.'</textarea>';
		  						 else
	               			echo '<textarea type="text" id="DescriptionScript" placeholder="Je traite uniquement sur rendez-vous de 8h à 20h toute la semaine et ne travaille que le week-end le samedi matin jusqu à 13h. Mon but est de vous mettre dans la meilleure forme possible." maxlength="8000" style="resize: none;" required></textarea>';
		  					 ?>
               <input type="submit" id="submit" name="" value="Submit">
            </div>
         </div>
         <div id="map" class="right">
            <p id="MapHead">Localisez votre lieu de travail</p>
         </div>
      </div>
