...
#role{border-radius: 12px;background:#2E2E2E;}
	    ...
	    <nav id="header">   <img src = "http://localhost/Alexis/images/KinemapFullLogo.png" id="Logo" alt = "Logo" onclick="window.location='http://localhost/Alexis/css/OtherHomeEnglish.html'" > <ul id="ul">
	      <li id="li"><a id="a" href="http://localhost/Alexis/OtherHomeNe.html" class="active"> Home </a></li>
		     ...
		     <div id="WTFF">
		       <a href="http://localhost/Alexis/OtherHomeNE.html">HOME</a>
		       <a href="http://localhost/Alexis/index.php">KAART</a>
		       <a href="http://localhost/Alexis/loginNe.php">LOG IN | SIGN UP</a>
		     </div>
    ...
    <div class="container">
		...
		<br>	<label for="password" class="sr-only">Wachtwoord</label>
			<input type="password" id="password" name ="pass" class="form-control" placeholder="Password" required> <br><br>
			Selecteer uw rol</label>
			<select name ="role" id="role">
				<option value="A">Admin</option>
					<option value="U" selected>Gebruiker</option>
			</select>
			<br><br><br><br>
			<button class="btn btn-md btn-primary btn-block" type="submit" name="submit" id="Login">Log In</button>
			<br><br>
			  <a href="#" id="ForgotPassword"> Wachtwoord vergeten? </a>
			<a href="http://localhost/Alexis/css/IWantT.html" id="SignUp">Inschrijven</a>
		</form>
