...
<html>
    <head>
        ...
        <style>
            ...
            @media screen and (max-width: 410px){#submittt{margin-top: 10px;}}
    ...
    <body background = "../images/WW11.jpg">
      <nav id="header">   <img src = "../images/KinemapFullLogooo.png" id="Logo" alt = "Logo" onclick="window.location='../home/home_en.php'" > <ul id="ul">
       <li id="li"><a id="a" href="../home/home_en.php" class="aa"> Home </a></li>
           <li id="li"><a id="a" href="../map/map_en.php" class="ab"> Map</a></li>
             <li id="li"><a id="a" href="../login/login.php" class="ac"> Log in | Sign up</a></li>
             <div class="WTF">
  ...
  <div class="Crack">
   <a class="Crock" href="../home/home_en.php">HOME</a>
