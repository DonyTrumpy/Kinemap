...
<html>
    ...
    <body background = "../images/WW11.jpg">
      <nav id="header">   <img src = "../images/KinemapFullLogooo.png" id="Logo" alt = "Logo" onclick="window.location='../home/home_ne.php'" > <ul id="ul">
       <li id="li"><a id="a" href="../home/home_ne.php" class="aa"> Home </a></li>
           <li id="li"><a id="a" href="../map/map_ne.php" class="ab"> Kaart</a></li>
             <li id="li"><a id="a" href="../login/login_ne.php" class="ac"> Log in | Sign up</a></li>
             <div class="WTF">
  ...
  <div class="Crack">
   <a class="Crock" href="../home/home_ne.php">HOME</a>
   <a class="Crock" href="../map/map_ne.php">KAART</a>
   <a class="Crock" href="../login/login_ne.php">LOG IN | SIGN UP</a>
  </div>
...
<?php
    if(!empty($_POST))
    {
        ...
        if (mail($toEmail, $subject, $message, $mailHeaders)) {
            echo "<alert id='success'> Bedankt voor je bericht, <br> <br> we antwoorden zo snel mogelijk terug! </alert>";
        }
	else {
