...
<html>
    <head>
        ...
        <style>
            ...
            @media screen and (max-width: 450px){#submittt{margin-top: 10px;}}
    ...
    <body background = "../images/WW11.jpg">
      <nav id="header">   <img src = "../images/KinemapFullLogooo.png" id="Logo" alt = "Logo" onclick="window.location='../home/home_fr.php'" > <ul id="ul">
       <li id="li"><a id="a" href="../home/home_fr.php" class="aa"> Home </a></li>
           <li id="li"><a id="a" href="../map/map_fr.php" class="ab"> Carte</a></li>
             <li id="li"><a id="a" href="../login/login_fr.php" class="ac"> Log in | Sign up</a></li>
             <div class="WTF">
  ...
  <div class="Crack">
   <a class="Crock" href="../home/home_fr.php">HOME</a>
   <a class="Crock" href="../map/map_fr.php">CARTE</a>
   <a class="Crock" href="../login/login_fr.php">LOG IN | SIGN UP</a>
  </div>
...
<?php
    if(!empty($_POST))
    {
        ...
        if (mail($toEmail, $subject, $message, $mailHeaders)) {
            echo "<alert id='success'> Merci pour votre message, <br> <br> nous vous répondrons dans les plus brefs délais! </alert>";
        }
	else {
