...
.ol-zoom{
   ...
   <body onload="init()">
		 ...
		 <nav id="header">   <img src = "http://localhost/Alexis/images/KinemapFullLogo.png" id="Logo" alt = "Logo" onclick="window.location='http://localhost/Alexis/OtherHomeNe.html'" style ="width: 145px; height : 50px;" > <ul id="ul">
 			<li id="li"><a id="a" href="http://localhost/Alexis/OtherHomeNe.html" class="active"> Home </a></li>
 					<li id="li"><a id="a" href="http://localhost/Alexis/indexNe.php">Kaart</a></li>
 						<li id="li"><a id="a" href="http://localhost/Alexis/loginNe.php"> Log in | Sign up</a></li>
 						<div class="WTF">
...
<div class="Crack">
	<a class="Crock" href="http://localhost/Alexis/OtherHomeNe.html">HOME</a>
	<a class="Crock" href="http://localhost/Alexis/indexNe.php">Kaart</a>
	<a class="Crock" href="http://localhost/Alexis/loginNe.php">LOG IN | SIGN UP</a>
</div>
...
<div class="Wyte">
							...
							<div class="Row" style="color: black;">
								   ...
								   <div class="divTableBody">
									  <div class="divTableRow">
										 <div class="divTableCell">
											<h3>Vul een of meer van de volgende filters in:</h3>
										 </div>
									  </div>
									  <div class="divTableRow">
										 <div class="divTableCell">
											<span class="FCity">Welk stad?</span>
										 </div>
									  </div>
									  <div class="divTableRow">
										 ...
										 <div id ="KHT" class="divTableCell">
											...
											<label for="FHome">&nbsp;Thuistherapie</label>
										 </div>
									  </div>
									  <div class="divTableRow">
										 <div class="divTableCell"><span class="FCity">Adres:</span></div>
									  </div>
									  <div class="divTableRow">
									  ...
									  <div class="divTableRow">
										 <div class="divTableCell"><span class="FCity">Wie?</span></div>
									  </div>
									  <div class="divTableRow">
										 ...
										 <div id ="KCT" class="divTableCell">
											...
											<label for="FConvention">&nbsp;Geconventioneerde therapeut&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
										 </div>
									  </div>
								   </div>
								</div>
								...
								<div class="Column">
									<p id="FSpecialization">Selecteer specialisatie:</p><div class="ABBA">
									<input type="checkbox" id="15" name="15" value="General physical therapy" onchange="getFilteredFeatures();">
									<label for="15">&nbsp;Algemene kinésithérapie</label>
...
<div class="Milf">
								...
								<div class="Column">
									<button id="FiltersOut" onclick="removeAllFilters();">Filters Verwijderen</button>
<br><br> <div class="Peri">
									<input type="checkbox" id="12" name="12" value="Osteopathy" onchange="getFilteredFeatures();">
									<label for="12">&nbsp;Osteopathie</label>
									<input type="checkbox" id="13" name="13" value="Pediatry" onchange="getFilteredFeatures();">
									<label for="13">&nbsp;Pediatrie</label>
									...
									<label for="21">&nbsp;Vestibulaire therapie</label>
							...
							<div class="containerDivider">
								...
								<div class="right">
									<div class="Blue">
										<div class="Row">
											<div class="Column">
												<h3 id="TName">Selecteer iemand</h3>
												<div>
											...
											<div id="BlueAdapt" class="Column">
												...
												<a id="liAgenda">Maak een afspraak</a>
											</div>
										</div>
										<br><br><br><br>
										<div class="Row">
											<div class="Column">
												<div class="onoffswitch">
													...
													<label class="onoffswitch-label" for="homeTherapy">&nbsp;&nbsp;Thuistherapie</label>
											...
											<div class="Column">
												<div class="onoffswitch">
													...
													<label class="onoffswitch-label" for="conventionTherapy">&nbsp;&nbsp;Geconventioneerde therapeut</label>
												</div>

											</div>
										</div>
										<br><br><br>
										<div id="DescriptionBlock">Dit is slechts een voorbeeld, kijk gerust eens op de kaart en gebruik de filters om de perfecte therapeut voor je te vinden.
										</div>
									</div>
								</div>
							</div>
