...
<div class="center">
<div class="User">
  <a id="FindT" href="../map/map_de.php">Finden sie einen Therapeut</a>
  <br><br><br><br><br>
...
<div class="Therapist">
  <a id="IAmT" href="../login/login_de.php">Ich bin ein Therapeut</a>
  <br><br><br><br><br>
...
<div class="Contact" id="Contact">
  ...
  <div class="FormBox">
      <form method="post">
          ...
          <div class="InputBox">
              ...
              <span class="spann">E-Mail-Addresse</span>
          </div>
          <div class="InputBox">
              <textarea name="message" required="required"></textarea>
              <span class="spann">Geben Sie Ihre Nachricht ein</span>
          </div>
  ...
  <div class="DownBlock">
    <a id="Politique" href="../source/Politique.php"> Datenschutzrichtlinie für personenbezogene Daten</a>
    <a id="Conditions" href="../source/Conditions.php">Geschäftsbedingungen</a>
  </div>
  </body>
</html>
