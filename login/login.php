...
html {background-color: #fff;}
  ...
  background-image: url('../images/WW10.jpg');
	...
	#Logo{padding-left:0px;margin-top: 11px;width:160px;width:130px;
	}}
  ...
  .popup.active .content {
	...
	@media screen and (max-width: 1100px) {
	  ...
	  #WTFF a{color:#fff;text-decoration: none;margin-left: 11vw;}
	}
...
#SignUp{
	...
	@media screen and (max-width: 450px) {
		#SignUp{font-size: 12px;margin-left: 25px;}}
