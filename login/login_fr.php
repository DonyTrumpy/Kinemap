...
@media screen and (max-width: 450px) {
	#ForgotPassword{font-size: 10px;margin-left: -10px;}}
...
#SignUp{
	...
	@media screen and (max-width: 450px) {
		#SignUp{font-size: 12px;margin-left: 16px;}}
...
#role{border-radius: 12px;background:#2E2E2E;color:#fff;position: absolute;top:274px; left:59%;}
@media screen and (max-width: 450px) {
	#role{top:300px;left:30%;}}

	</style>

		<body>
	    <nav id="header">   <img src = "../images/KinemapFullLogooo.png" id="Logo" alt = "Logo" onclick="window.location='../'" > <ul id="ul">
	      <li id="li"><a id="a" href="../home/home_fr.php" class="active"> Home </a></li>
	          <li id="li"><a id="a" href="../map/map_fr.php"> Carte</a></li>
	            <li id="li"><a id="a" href="../login/login_fr.php"> Log in | Sign up</a></li>
	            <div class="WTF">
    ...
    <div class="container">
		...
		<form class="form-signin" method="post" action="../source/loginproc.php">
			...
			<input type="text" id="username" name ="username" class="form-control mb-2" placeholder="Nom d'utilisateur" required autofocus><br>
		<br>	<label for="password" class="sr-only"></label>
			<input type="password" id="password" name ="pass" class="form-control" placeholder="Mot de passe" required> <br><br><br><br><br>
			<label id="Rolee">Selectionnez votre rôle</label>
			...
			<br><br>
			  <a href="../source/contact_us_fr.php" id="ForgotPassword"> Mot de passe oublié? </a>
			<a href="../source/select_plans_fr.php" id="SignUp">S'inscrire</a>
		</form>
  ...
  if(isset($_GET['s'])){
      $s = $_GET['s'];
		switch ($s){
			...
			case 'lf':
				echo  '<script type="text/javascript" language="javascript">
				swal("Error", "Il est possible que votre rôle soit différent ou que votre e-mail / mot de passe soit incorrect. Veuillez réessayer.", "error");</script>';
			break;
			case 'fl':
				echo  '<script type="text/javascript" language="javascript">
				swal("Error", "Désolé, vous devez vous connecter", "error");</script>';
			break;
			case 'success':
				echo  '<script type="text/javascript" language="javascript">
				swal("Success", "Enregistré avec succès. Veuillez vous connecter en utilisant vos identifiants", "success");</script>';
			break;
			default:
		}
    }
